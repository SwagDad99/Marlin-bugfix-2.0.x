...
#define DUAL_X_CARRIAGE
  ...
  #define X2_MAX_POS   367.2       // Set this to the distance between toolheads when both heads are homed  Swaggy was 480 Measured 3/19/22
...
#define FWRETRACT
  ...
  #endif
  #define RETRACT_LENGTH                .3   // (mm) Default retract length (positive value)  3
